...
namespace GildedRoseKata
{
    ...
    public class Program
    {
        ...
        /// <summary>
        /// Determines the number of days to run the simulation.
        /// </summary>
        ...
        /// <summary>
        /// Displays details of all items in the inventory.
        /// </summary>
        private static void DisplayItemDetails(IEnumerable<Item> items)
        {
