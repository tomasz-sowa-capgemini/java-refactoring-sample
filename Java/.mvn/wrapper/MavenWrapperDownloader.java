...
/**
 * Utility class responsible for downloading the Maven Wrapper JAR file.
 */
public class MavenWrapperDownloader {
    ...
    /** Path to the maven-wrapper.properties file, which might contain a custom download URL. */
    private static final String MAVEN_WRAPPER_PROPERTIES_PATH = ".mvn/wrapper/maven-wrapper.properties";

    /** Path where the maven-wrapper.jar will be saved. */
    private static final String MAVEN_WRAPPER_JAR_PATH = ".mvn/wrapper/maven-wrapper.jar";

    /** Property name used to override the default download URL for the wrapper. */
    private static final String PROPERTY_NAME_WRAPPER_URL = "wrapperUrl";

    /**
     * Main entry point for downloading the Maven Wrapper JAR file.
     *
    ...
    /**
     * Resolves the download URL from the properties file if available, otherwise uses the default URL.
     *
     ...
     *
     * @param outputFile The file whose parent directory should be created.
     */
    private static void createOutputDirectory(File outputFile) {
     ...
     * @param destination The file destination to save the downloaded content.
    ...
    /**
     * Configures HTTP authentication if environment variables are set.
     */
