...
/**
 * Maven Wrapper Downloader utility.
...
public class MavenWrapperDownloader {
    ...
    /** Path to the maven-wrapper.properties file, which may contain a custom download URL. */
    ...
    /**
     * Resolves the download URL from the properties file if available, otherwise returns the default URL.
     *
    ...
    /**
     * Ensures the output directory exists before downloading the file.
     *
