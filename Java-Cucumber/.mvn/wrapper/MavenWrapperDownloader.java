...
public class MavenWrapperDownloader {
    ...
    /**
     * Main entry point for the Maven Wrapper Downloader.
     *
     * @param args command-line arguments; expects the base directory path as the first argument
     */
    ...
    /**
     * Resolves the download URL for the Maven Wrapper JAR.
     *
    ...
    /**
     * Ensures that the output directory for the wrapper JAR exists.
     *
