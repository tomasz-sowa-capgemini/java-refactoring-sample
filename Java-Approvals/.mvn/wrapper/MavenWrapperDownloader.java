 ...
 * <p>
 * This class downloads the Maven Wrapper JAR file if it does not exist locally.
 */
public class MavenWrapperDownloader {

    private static final String WRAPPER_VERSION = "0.5.6";

    /** Default URL to download the maven-wrapper.jar if no custom URL is provided. */
    ...
    /** Property name for overriding the default download URL. */
    ...
    /**
     * Resolves the download URL from the properties file if available, otherwise uses the default.
     *
     ...
     *
     * @param outputFile the output file whose parent directory should exist
     */
    ...
    /**
     * Configures authentication using environment variables if provided.
     */
