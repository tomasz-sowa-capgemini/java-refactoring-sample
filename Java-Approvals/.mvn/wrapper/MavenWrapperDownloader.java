...
public class MavenWrapperDownloader {
     ...
     *
     * @param args the first argument should be the base directory
     */
    ...
    /**
     * Resolves the download URL from the properties file if available,
    ...
    /**
     * Ensures the output directory exists before downloading.
     *
     * @param outputFile the file to be created
     */
    private static void createOutputDirectoryIfNeeded(File outputFile) {
    ...
    private static void downloadFileFromURL(String urlString, File destination) throws Exception {
        configureAuthenticationIfNeeded();
     ...
     */
    private static void configureAuthenticationIfNeeded() {
