 ...
 * Simulates the passage of days and updates item quality accordingly.
 */
public class Program {

    private static final int TOTAL_SIMULATION_DAYS = 31;
    ...
    public static void main(String... args) {
        ...
        simulateDays(gildedRoseApp, items, TOTAL_SIMULATION_DAYS);
    }
    ...
    /**
     * Simulates the progression of days, printing item states and updating quality.
     *
